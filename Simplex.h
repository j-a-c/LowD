...
static const float F4 = (sqrt(5.0)-1.0)/4.0;
...
float noise(float xin, float yin) 
{
    ...
    int ii = i & 255;
    int jj = j & 255;
    int gi0 = permMod12[ii+perm1[jj]];
    int gi1 = permMod12[ii+i1+perm1[jj+j1]];
    int gi2 = permMod12[ii+1+perm1[jj+1]];
